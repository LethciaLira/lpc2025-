...
# Áudio (efeitos sonoros)  # alteração Sexta-Feira
MASTER_VOLUME = 0.5  # alteração Sexta-Feira
SND_PLAYER_SHOOT = "assets/sounds/player_shoot.mp3"  # alteração Sexta-Feira
SND_UFO_SHOOT = "assets/sounds/ufo_shoot.mp3"  # alteração Sexta-Feira
SND_EXPLOSION = "assets/sounds/explosion.mp3"  # alteração Sexta-Feira
