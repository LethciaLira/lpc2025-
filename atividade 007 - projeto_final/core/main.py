...
# --- CLASSE TANK (Com __init__ corrigido e simplificado) ---
class Tank(pygame.sprite.Sprite): 
    ...
    def __init__(self, color, x, y, controls):
        ...
        # 3. CÓPIA para self.original_image (AGORA É GARANTIDO QUE self.image EXISTE)
    ...
    def rotate(self, angle_change):
        ...
        # A imagem atual é atualizada com a versão rotacionada da original_image
    ...
    def fire(self, bullets_group):
        if self.fire_cooldown <= 0:
            # Passar 'owner=self'
            new_bullet = Bullet(self.rect.centerx, self.rect.centery, self.angle, owner=self)
...
def run_tank_game():
    ...
    # IMPORTANTE: Inicializar Pygame aqui se for rodar este arquivo diretamente
    ...
    # A classe Scoreboard agora espera que Pygame.font esteja inicializado (feito acima)
    ...
    # CRÍTICO: Passar as tuplas de cores
    ...
    while running:
        ...
        # Colisões Bala vs. Tanques (CORREÇÃO DE PONTUAÇÃO)
        for tank in tanks_group:
